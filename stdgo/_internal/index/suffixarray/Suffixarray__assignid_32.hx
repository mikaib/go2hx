...
function _assignID_32(_text:stdgo.Slice<stdgo.GoInt32>, _sa:stdgo.Slice<stdgo.GoInt32>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        ...
        var _iterator_3898174_23:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 3898725i32;
                    } else {
                        _gotoNext = 3898729i32;
                    };
                } else if (__value__ == (3898200i32)) {
                    _j_24 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(_iterator_3898174_23 : stdgo.GoInt)];
                    _n_25 = _sa[((_j_24 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)];
                    if (_n_25 != (_lastLen_21)) {
                        _gotoNext = 3898319i32;
                    } else {
                        _gotoNext = 3898339i32;
                    };
                } else if (__value__ == (3898319i32)) {
                    _gotoNext = 3898656i32;
                } else if (__value__ == (3898339i32)) {
                    if (((_n_25 : stdgo.GoUInt32) >= (_text.length : stdgo.GoUInt32) : Bool)) {
                        _gotoNext = 3898373i32;
                    } else {
                        _gotoNext = 3898458i32;
                    };
                } else if (__value__ == (3898373i32)) {
                    _gotoNext = 3898697i32;
                } else if (__value__ == (3898458i32)) {
                    ...
                    _i_29 = (0 : stdgo.GoInt);
                    _gotoNext = 3898560i32;
                    {
                        _gotoNext = 3898458i32;
                    };
                } else if (__value__ == (3898560i32)) {
                    if ((_i_29 < _n_26 : Bool)) {
                        _gotoNext = 3898583i32;
                    } else {
                        _gotoNext = 3898641i32;
                    };
                } else if (__value__ == (3898579i32)) {
                    _i_29++;
                    _gotoNext = 3898560i32;
                } else if (__value__ == (3898583i32)) {
                    if (_this_27[(_i_29 : stdgo.GoInt)] != (_last_28[(_i_29 : stdgo.GoInt)])) {
                        _gotoNext = 3898611i32;
                    } else {
                        _gotoNext = 3898579i32;
                    };
                } else if (__value__ == (3898611i32)) {
                    _gotoNext = 3898656i32;
                } else if (__value__ == (3898641i32)) {
                    _gotoNext = 3898697i32;
                    ...
                    _lastLen_21 = _n_25;
                    _gotoNext = 3898697i32;
                } else if (__value__ == (3898697i32)) {
                    _sa[((_j_24 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)] = (_id_20 : stdgo.GoInt32);
                    _iterator_3898174_23++;
                    _gotoNext = 3898726i32;
                } else if (__value__ == (3898725i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(0i32 : stdgo.GoInt)];
                        _iterator_3898174_23 = @:binopAssign __tmp__0;
                        _j_24 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 3898726i32;
                } else if (__value__ == (3898726i32)) {
                    if (_iterator_3898174_23 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 3898200i32;
                    } else {
                        _gotoNext = 3898729i32;
                    };
                } else if (__value__ == (3898729i32)) {
                    return _id_20;
                    _gotoNext = -1i32;
                };
            };

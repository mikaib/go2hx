...
function _processOptions(_env:stdgo.GoString):Void {
        ...
        var _iterator_6767_7:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _o_8 = stdgo._internal.internal.cpu.Cpu__options._options[(_iterator_6767_7 : stdgo.GoInt)];
                    if (!_o_8.specified) {
                        _gotoNext = 6801i32;
                    } else {
                        _gotoNext = 6822i32;
                ...
                } else if (__value__ == (6968i32)) {
                    {
                        ...
                        _iterator_6767_7 = @:binopAssign __tmp__0;
                        _o_8 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 6969i32;
                } else if (__value__ == (6969i32)) {
                    if (_iterator_6767_7 < (stdgo._internal.internal.cpu.Cpu__options._options.length)) {
                        _gotoNext = 6781i32;
                    } else {
                        _gotoNext = 6971i32;
                    };

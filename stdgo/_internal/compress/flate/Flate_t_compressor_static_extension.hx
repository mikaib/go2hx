        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if (((((@:checkr _d ?? throw "null pointer dereference")._windowEnd - (@:checkr _d ?? throw "null pointer dereference")._index : stdgo.GoInt) < (262 : stdgo.GoInt) : Bool) && !(@:checkr _d ?? throw "null pointer dereference")._sync : Bool)) {
                        _gotoNext = 3687878i32;
                    } else {
                        _gotoNext = 3687894i32;
                    };
                } else if (__value__ == (3687878i32)) {
                    return;
                    _gotoNext = 3687894i32;
                } else if (__value__ == (3687894i32)) {
                    ...
                    _gotoNext = 3687949i32;
                } else if (__value__ == (3687949i32)) {
                    0i32;
                    loopBreak = false;
                    _gotoNext = 3687956i32;
                } else if (__value__ == (3687956i32)) {
                    if (!loopBreak) {
                        _gotoNext = 3687960i32;
                    } else {
                        _gotoNext = 3691859i32;
                    };
                } else if (__value__ == (3687960i32)) {
                    if (((@:checkr _d ?? throw "null pointer dereference")._index > (@:checkr _d ?? throw "null pointer dereference")._windowEnd : Bool)) {
                        _gotoNext = 3687989i32;
                    } else {
                        _gotoNext = 3688027i32;
                    };
                } else if (__value__ == (3687989i32)) {
                    throw stdgo.Go.toInterface(("index > windowEnd" : stdgo.GoString));
                    _gotoNext = 3688027i32;
                } else if (__value__ == (3688027i32)) {
                    ...
                    if ((_lookahead_0 < (262 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3688109i32;
                    } else {
                        _gotoNext = 3688652i32;
                    };
                } else if (__value__ == (3688109i32)) {
                    if (!(@:checkr _d ?? throw "null pointer dereference")._sync) {
                        _gotoNext = 3688125i32;
                    } else {
                        _gotoNext = 3688150i32;
                    };
                } else if (__value__ == (3688125i32)) {
                    loopBreak = true;
                    _gotoNext = 3687956i32;
                } else if (__value__ == (3688150i32)) {
                    if (((@:checkr _d ?? throw "null pointer dereference")._index > (@:checkr _d ?? throw "null pointer dereference")._windowEnd : Bool)) {
                        _gotoNext = 3688175i32;
                    } else {
                        _gotoNext = 3688216i32;
                    };
                } else if (__value__ == (3688175i32)) {
                    throw stdgo.Go.toInterface(("index > windowEnd" : stdgo.GoString));
                    _gotoNext = 3688216i32;
                } else if (__value__ == (3688216i32)) {
                    if (_lookahead_0 == ((0 : stdgo.GoInt))) {
                        _gotoNext = 3688234i32;
                    } else {
                        _gotoNext = 3688652i32;
                    };
                } else if (__value__ == (3688234i32)) {
                    if ((@:checkr _d ?? throw "null pointer dereference")._byteAvailable) {
                        _gotoNext = 3688301i32;
                    } else {
                        _gotoNext = 3688484i32;
                    };
                } else if (__value__ == (3688301i32)) {
                    ...
                    _gotoNext = 3688484i32;
                } else if (__value__ == (3688484i32)) {
                    if ((((@:checkr _d ?? throw "null pointer dereference")._tokens.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3688505i32;
                    } else {
                        _gotoNext = 3688630i32;
                    };
                } else if (__value__ == (3688505i32)) {
                    {
                        ...
                        if ((@:checkr _d ?? throw "null pointer dereference")._err != null) {
                            _gotoNext = 3688569i32;
                        } else {
                            _gotoNext = 3688596i32;
                        };
                    };
                } else if (__value__ == (3688569i32)) {
                    return;
                    _gotoNext = 3688596i32;
                } else if (__value__ == (3688596i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._tokens = ((@:checkr _d ?? throw "null pointer dereference")._tokens.__slice__(0, (0 : stdgo.GoInt)) : stdgo.Slice<stdgo._internal.compress.flate.Flate_t_token.T_token>);
                    _gotoNext = 3688630i32;
                } else if (__value__ == (3688630i32)) {
                    loopBreak = true;
                    _gotoNext = 3687956i32;
                } else if (__value__ == (3688652i32)) {
                    if (((@:checkr _d ?? throw "null pointer dereference")._index < (@:checkr _d ?? throw "null pointer dereference")._maxInsertIndex : Bool)) {
                        _gotoNext = 3688682i32;
                    } else {
                        _gotoNext = 3688931i32;
                    };
                } else if (__value__ == (3688682i32)) {
                    ...
                    if ((_minIndex_5 < (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3689079i32;
                    } else {
                        _gotoNext = 3689104i32;
                    };
                } else if (__value__ == (3689079i32)) {
                    _minIndex_5 = (0 : stdgo.GoInt);
                    _gotoNext = 3689104i32;
                } else if (__value__ == (3689104i32)) {
                ...
                } else if (__value__ == (3689302i32)) {
                    {
                        ...
                        if (_ok_8) {
                            _gotoNext = 3689418i32;
                        } else {
                            _gotoNext = 3689481i32;
                        };
                    };
                } else if (__value__ == (3689418i32)) {
                    ...
                    if ((((@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing != ((2147483647 : stdgo.GoInt)) && ((@:checkr _d ?? throw "null pointer dereference")._length >= (4 : stdgo.GoInt) : Bool) : Bool) || (((@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing == ((2147483647 : stdgo.GoInt)) && (_prevLength_3 >= (4 : stdgo.GoInt) : Bool) : Bool) && ((@:checkr _d ?? throw "null pointer dereference")._length <= _prevLength_3 : Bool) : Bool) : Bool)) {
                        _gotoNext = 3689640i32;
                    } else {
                        _gotoNext = 3691391i32;
                    };
                } else if (__value__ == (3689640i32)) {
                    if ((@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing != ((2147483647 : stdgo.GoInt))) {
                        _gotoNext = 3689795i32;
                    } else {
                        _gotoNext = 3689919i32;
                    };
                } else if (__value__ == (3689795i32)) {
                    ...
                    _gotoNext = 3690267i32;
                } else if (__value__ == (3689919i32)) {
                    _gotoNext = 3689919i32;
                    ...
                    if (((@:checkr _d ?? throw "null pointer dereference")._length <= (@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing : Bool)) {
                        _gotoNext = 3690300i32;
                    } else {
                        _gotoNext = 3691044i32;
                    };
                } else if (__value__ == (3690300i32)) {
                    if ((@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing != ((2147483647 : stdgo.GoInt))) {
                        _gotoNext = 3690361i32;
                    } else {
                        _gotoNext = 3690409i32;
                    };
                } else if (__value__ == (3690361i32)) {
                    ...
                    _index_10++;
                    _gotoNext = 3690483i32;
                } else if (__value__ == (3690483i32)) {
                    if ((_index_10 < _newIndex_9 : Bool)) {
                        _gotoNext = 3690522i32;
                    } else {
                        _gotoNext = 3690907i32;
                    };
                } else if (__value__ == (3690514i32)) {
                    _index_10++;
                    _gotoNext = 3690483i32;
                } else if (__value__ == (3690522i32)) {
                    if ((_index_10 < (@:checkr _d ?? throw "null pointer dereference")._maxInsertIndex : Bool)) {
                        _gotoNext = 3690557i32;
                    } else {
                        _gotoNext = 3690514i32;
                    };
                } else if (__value__ == (3690557i32)) {
                    ...
                    _gotoNext = 3690514i32;
                } else if (__value__ == (3690907i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._index = _index_10;
                    if ((@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing == ((2147483647 : stdgo.GoInt))) {
                        _gotoNext = 3690962i32;
                    } else {
                        _gotoNext = 3691178i32;
                    };
                } else if (__value__ == (3690962i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._byteAvailable = false;
                    (@:checkr _d ?? throw "null pointer dereference")._length = (3 : stdgo.GoInt);
                    _gotoNext = 3691178i32;
                } else if (__value__ == (3691044i32)) {
                    _gotoNext = 3691044i32;
                    ...
                    0i32;
                    _gotoNext = 3691178i32;
                } else if (__value__ == (3691178i32)) {
                    if (((@:checkr _d ?? throw "null pointer dereference")._tokens.length) == ((16384 : stdgo.GoInt))) {
                        _gotoNext = 3691218i32;
                    } else {
                        _gotoNext = 3687956i32;
                    };
                } else if (__value__ == (3691218i32)) {
                    {
                        (@:checkr _d ?? throw "null pointer dereference")._err = @:check2r _d._writeBlock((@:checkr _d ?? throw "null pointer dereference")._tokens, (@:checkr _d ?? throw "null pointer dereference")._index);
                        if ((@:checkr _d ?? throw "null pointer dereference")._err != null) {
                            _gotoNext = 3691329i32;
                        } else {
                            _gotoNext = 3691353i32;
                        };
                    };
                } else if (__value__ == (3691329i32)) {
                    return;
                    _gotoNext = 3691353i32;
                } else if (__value__ == (3691353i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._tokens = ((@:checkr _d ?? throw "null pointer dereference")._tokens.__slice__(0, (0 : stdgo.GoInt)) : stdgo.Slice<stdgo._internal.compress.flate.Flate_t_token.T_token>);
                    _gotoNext = 3687956i32;
                } else if (__value__ == (3691391i32)) {
                    _gotoNext = 3691391i32;
                    if ((((@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing != (2147483647 : stdgo.GoInt)) || (@:checkr _d ?? throw "null pointer dereference")._byteAvailable : Bool)) {
                        _gotoNext = 3691449i32;
                    } else {
                        _gotoNext = 3691771i32;
                    };
                } else if (__value__ == (3691449i32)) {
                    _i_13 = ((@:checkr _d ?? throw "null pointer dereference")._index - (1 : stdgo.GoInt) : stdgo.GoInt);
                    if ((@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing != ((2147483647 : stdgo.GoInt))) {
                        _gotoNext = 3691510i32;
                    } else {
                        _gotoNext = 3691539i32;
                    };
                } else if (__value__ == (3691510i32)) {
                    ...
                    if (((@:checkr _d ?? throw "null pointer dereference")._tokens.length) == ((16384 : stdgo.GoInt))) {
                        _gotoNext = 3691646i32;
                    } else {
                        _gotoNext = 3691771i32;
                    };
                } else if (__value__ == (3691646i32)) {
                    {
                        ...
                        if ((@:checkr _d ?? throw "null pointer dereference")._err != null) {
                            _gotoNext = 3691706i32;
                        } else {
                            _gotoNext = 3691733i32;
                        };
                    };
                } else if (__value__ == (3691706i32)) {
                    return;
                    _gotoNext = 3691733i32;
                } else if (__value__ == (3691733i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._tokens = ((@:checkr _d ?? throw "null pointer dereference")._tokens.__slice__(0, (0 : stdgo.GoInt)) : stdgo.Slice<stdgo._internal.compress.flate.Flate_t_token.T_token>);
                    _gotoNext = 3691771i32;
                } else if (__value__ == (3691771i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._index++;
                    if ((@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing == ((2147483647 : stdgo.GoInt))) {
                        _gotoNext = 3691818i32;
                    } else {
                        _gotoNext = 3687956i32;
                    };
                } else if (__value__ == (3691818i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._byteAvailable = true;
                    _gotoNext = 3687956i32;
                } else if (__value__ == (3691859i32)) {
                    _gotoNext = -1i32;
                };
            };
        };

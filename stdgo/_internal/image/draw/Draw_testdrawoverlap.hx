...
function testDrawOverlap(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        var _iterator_5013797_11:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if ((0i32 : stdgo.GoInt) < ((new stdgo.Slice<stdgo._internal.image.draw.Draw_op.Op>(2, 2, ...[(0 : stdgo._internal.image.draw.Draw_op.Op), (1 : stdgo._internal.image.draw.Draw_op.Op)]).__setNumber32__() : stdgo.Slice<stdgo._internal.image.draw.Draw_op.Op>).length)) {
                        _gotoNext = 5014989i32;
                    } else {
                        _gotoNext = 5014992i32;
                    };
                } else if (__value__ == (5013788i32)) {
                    _iterator_5013797_11++;
                    _gotoNext = 5014990i32;
                } else if (__value__ == (5013819i32)) {
                    _op_12 = (new stdgo.Slice<stdgo._internal.image.draw.Draw_op.Op>(2, 2, ...[(0 : stdgo._internal.image.draw.Draw_op.Op), (1 : stdgo._internal.image.draw.Draw_op.Op)]).__setNumber32__() : stdgo.Slice<stdgo._internal.image.draw.Draw_op.Op>)[(_iterator_5013797_11 : stdgo.GoInt)];
                    _yoff_13 = (-2 : stdgo.GoInt);
                    _gotoNext = 5013823i32;
                } else if (__value__ == (5013823i32)) {
                    if ((_yoff_13 <= (2 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 5013857i32;
                    } else {
                        _gotoNext = 5013788i32;
                    };
                } else if (__value__ == (5013850i32)) {
                    _yoff_13++;
                    _gotoNext = 5013823i32;
                } else if (__value__ == (5013857i32)) {
                    _gotoNext = 5013861i32;
                } else if (__value__ == (5013861i32)) {
                    _xoff_14 = (-2 : stdgo.GoInt);
                    _loopBreak = false;
                    _gotoNext = 5013870i32;
                } else if (__value__ == (5013870i32)) {
                    if (!_loopBreak && ((_xoff_14 <= (2 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 5013904i32;
                    } else {
                        _gotoNext = 5013850i32;
                    };
                } else if (__value__ == (5013897i32)) {
                    _xoff_14++;
                    _gotoNext = 5013870i32;
                } else if (__value__ == (5013904i32)) {
                    ...
                    if (!_b_18.eq(_golden_19.bounds()?.__copy__())) {
                        _gotoNext = 5014318i32;
                    } else {
                        _gotoNext = 5014551i32;
                    };
                } else if (__value__ == (5014318i32)) {
                    ...
                    _y_20 = _b_18.min.y;
                    _gotoNext = 5014683i32;
                } else if (__value__ == (5014683i32)) {
                    if ((_y_20 < _b_18.max.y : Bool)) {
                        _gotoNext = 5014718i32;
                    } else {
                        _gotoNext = 5013897i32;
                    };
                } else if (__value__ == (5014714i32)) {
                    _y_20++;
                    _gotoNext = 5014683i32;
                } else if (__value__ == (5014718i32)) {
                    _x_21 = _b_18.min.x;
                    _gotoNext = 5014725i32;
                } else if (__value__ == (5014725i32)) {
                    if ((_x_21 < _b_18.max.x : Bool)) {
                        _gotoNext = 5014760i32;
                    } else {
                        _gotoNext = 5014714i32;
                    };
                } else if (__value__ == (5014756i32)) {
                    _x_21++;
                    _gotoNext = 5014725i32;
                } else if (__value__ == (5014760i32)) {
                    if (!stdgo._internal.image.draw.Draw__eq._eq(@:check2r _dst_16.at(_x_21, _y_20), _golden_19.at(_x_21, _y_20))) {
                        _gotoNext = 5014806i32;
                    } else {
                        _gotoNext = 5014756i32;
                    };
                } else if (__value__ == (5014806i32)) {
                ...
                } else if (__value__ == (5014989i32)) {
                    {
                        ...
                        _iterator_5013797_11 = @:binopAssign __tmp__0;
                        _op_12 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 5014990i32;
                } else if (__value__ == (5014990i32)) {
                    if (_iterator_5013797_11 < ((new stdgo.Slice<stdgo._internal.image.draw.Draw_op.Op>(2, 2, ...[(0 : stdgo._internal.image.draw.Draw_op.Op), (1 : stdgo._internal.image.draw.Draw_op.Op)]).__setNumber32__() : stdgo.Slice<stdgo._internal.image.draw.Draw_op.Op>).length)) {
                        _gotoNext = 5013819i32;
                    } else {
                        _gotoNext = 5014992i32;
                    };
                } else if (__value__ == (5014992i32)) {
                    _gotoNext = -1i32;
                };
            };
        };

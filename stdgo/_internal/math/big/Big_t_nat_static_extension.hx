        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 4232999i32;
                } else if (__value__ == (4232999i32)) {
                    if (!nextRandomBreak && ((_i_9 < _reps : Bool))) {
                        _gotoNext = 4233025i32;
                    } else {
                        _gotoNext = 4233456i32;
                    };
                } else if (__value__ == (4233025i32)) {
                    if (((_i_9 == (_reps - (1 : stdgo.GoInt) : stdgo.GoInt)) && _force2 : Bool)) {
                        _gotoNext = 4233054i32;
                    } else {
                        _gotoNext = 4233086i32;
                    };
                } else if (__value__ == (4233054i32)) {
                    _x_5 = _x_5._set(stdgo._internal.math.big.Big__nattwo._natTwo);
                    _gotoNext = 4233153i32;
                } else if (__value__ == (4233086i32)) {
                    _gotoNext = 4233086i32;
                    _x_5 = _x_5._random(_rand_4, _nm3_3, _nm3Len_8);
                    _x_5 = _x_5._add(_x_5, stdgo._internal.math.big.Big__nattwo._natTwo);
                    0i32;
                    _gotoNext = 4233153i32;
                } else if (__value__ == (4233153i32)) {
                    ...
                    if (((_y_6._cmp(stdgo._internal.math.big.Big__natone._natOne) == (0 : stdgo.GoInt)) || (_y_6._cmp(_nm1_0) == (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 4233224i32;
                    } else {
                        _gotoNext = 4233244i32;
                    };
                } else if (__value__ == (4233224i32)) {
                    _i_9++;
                    _gotoNext = 4232999i32;
                } else if (__value__ == (4233244i32)) {
                    _j_10 = (1u32 : stdgo.GoUInt);
                    _gotoNext = 4233244i32;
                    if ((_j_10 < _k_1 : Bool)) {
                        _gotoNext = 4233273i32;
                    } else {
                        _gotoNext = 4233438i32;
                    };
                } else if (__value__ == (4233269i32)) {
                    _j_10++;
                    _gotoNext = 4233244i32;
                } else if (__value__ == (4233273i32)) {
                    _y_6 = _y_6._sqr(_y_6);
                    {
                    ...
                    if (_y_6._cmp(_nm1_0) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4233352i32;
                    } else {
                        _gotoNext = 4233386i32;
                    };
                } else if (__value__ == (4233352i32)) {
                    _i_9++;
                    _gotoNext = 4232999i32;
                } else if (__value__ == (4233386i32)) {
                    if (_y_6._cmp(stdgo._internal.math.big.Big__natone._natOne) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4233408i32;
                    } else {
                        _gotoNext = 4233269i32;
                    };
                } else if (__value__ == (4233408i32)) {
                    return false;
                    _gotoNext = 4233269i32;
                } else if (__value__ == (4233438i32)) {
                    return false;
                    _i_9++;
                    _gotoNext = 4232999i32;
                } else if (__value__ == (4233456i32)) {
                    return true;
                    _gotoNext = -1i32;
                };
            };

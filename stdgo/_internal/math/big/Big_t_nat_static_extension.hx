        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 4267312i32;
                } else if (__value__ == (4267312i32)) {
                    _i_9 = (0 : stdgo.GoInt);
                    nextRandomBreak = false;
                    _gotoNext = 4267325i32;
                } else if (__value__ == (4267325i32)) {
                    if (!nextRandomBreak && ((_i_9 < _reps : Bool))) {
                        _gotoNext = 4267351i32;
                    } else {
                        _gotoNext = 4267782i32;
                    };
                } else if (__value__ == (4267351i32)) {
                    if (((_i_9 == (_reps - (1 : stdgo.GoInt) : stdgo.GoInt)) && _force2 : Bool)) {
                        _gotoNext = 4267380i32;
                    } else {
                        _gotoNext = 4267412i32;
                    };
                } else if (__value__ == (4267380i32)) {
                    _x_5 = _x_5._set(stdgo._internal.math.big.Big__nattwo._natTwo);
                    _gotoNext = 4267479i32;
                } else if (__value__ == (4267412i32)) {
                    _gotoNext = 4267412i32;
                    _x_5 = _x_5._random(_rand_4, _nm3_3, _nm3Len_8);
                    _x_5 = _x_5._add(_x_5, stdgo._internal.math.big.Big__nattwo._natTwo);
                    0i32;
                    _gotoNext = 4267479i32;
                } else if (__value__ == (4267479i32)) {
                    ...
                    if (((_y_6._cmp(stdgo._internal.math.big.Big__natone._natOne) == (0 : stdgo.GoInt)) || (_y_6._cmp(_nm1_0) == (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 4267550i32;
                    } else {
                        _gotoNext = 4267570i32;
                    };
                } else if (__value__ == (4267550i32)) {
                    _i_9++;
                    _gotoNext = 4267325i32;
                } else if (__value__ == (4267570i32)) {
                    _j_10 = (1u32 : stdgo.GoUInt);
                    _gotoNext = 4267570i32;
                    if ((_j_10 < _k_1 : Bool)) {
                        _gotoNext = 4267599i32;
                    } else {
                        _gotoNext = 4267764i32;
                    };
                } else if (__value__ == (4267595i32)) {
                    _j_10++;
                    _gotoNext = 4267570i32;
                } else if (__value__ == (4267599i32)) {
                    _y_6 = _y_6._sqr(_y_6);
                    {
                    ...
                    if (_y_6._cmp(_nm1_0) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4267678i32;
                    } else {
                        _gotoNext = 4267712i32;
                    };
                } else if (__value__ == (4267678i32)) {
                    _i_9++;
                    _gotoNext = 4267325i32;
                } else if (__value__ == (4267712i32)) {
                    if (_y_6._cmp(stdgo._internal.math.big.Big__natone._natOne) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4267734i32;
                    } else {
                        _gotoNext = 4267595i32;
                    };
                } else if (__value__ == (4267734i32)) {
                    return false;
                    _gotoNext = 4267595i32;
                } else if (__value__ == (4267764i32)) {
                    return false;
                    _i_9++;
                    _gotoNext = 4267325i32;
                } else if (__value__ == (4267782i32)) {
                    return true;
                    _gotoNext = -1i32;
                };
            };

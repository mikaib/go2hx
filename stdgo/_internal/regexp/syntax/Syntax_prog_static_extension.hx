        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 3655035i32;
                } else if (__value__ == (3655035i32)) {
                    0i32;
                    loopBreak = false;
                    _gotoNext = 3655042i32;
                } else if (__value__ == (3655042i32)) {
                    if (!loopBreak) {
                        _gotoNext = 3655046i32;
                    } else {
                        _gotoNext = 3655256i32;
                    };
                } else if (__value__ == (3655046i32)) {
                ...
                } else if (__value__ == (3655050i32)) {
                    {
                        ...
                        if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            ...
                            _gotoNext = 3655154i32;
                        } else {
                            _gotoNext = 3655194i32;
                        };
                    };
                } else if (__value__ == (3655066i32)) {

        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 4277987i32;
                } else if (__value__ == (4277987i32)) {
                    0i32;
                    _redoBreak = false;
                    _gotoNext = 4278015i32;
                } else if (__value__ == (4278015i32)) {
                    if (!_redoBreak && (((@:checkr _s ?? throw "null pointer dereference").whitespace & (((1i64 : stdgo.GoUInt64) << (_ch_0 : stdgo.GoUInt) : stdgo.GoUInt64)) : stdgo.GoUInt64) != (0i64 : stdgo.GoUInt64))) {
                        _gotoNext = 4278051i32;
                    } else {
                        _gotoNext = 4278106i32;
                    };
                } else if (__value__ == (4278051i32)) {
                    _ch_0 = @:check2r _s._next();
                    _gotoNext = 4278015i32;
                } else if (__value__ == (4278106i32)) {
                    ...
                    if (((@:checkr _s ?? throw "null pointer dereference")._column > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4278303i32;
                    } else {
                        _gotoNext = 4278401i32;
                    };
                } else if (__value__ == (4278303i32)) {
                    ...
                    _gotoNext = 4278612i32;
                } else if (__value__ == (4278401i32)) {
                    _gotoNext = 4278401i32;
                    ...
                    0i32;
                    _gotoNext = 4278612i32;
                } else if (__value__ == (4278612i32)) {
                    _tok_1 = _ch_0;
                    _gotoNext = 4278623i32;
                } else if (__value__ == (4278623i32)) {
                    if (@:check2r _s._isIdentRune(_ch_0, (0 : stdgo.GoInt))) {
                        _gotoNext = 4278633i32;
                    } else if (stdgo._internal.text.scanner.Scanner__isdecimal._isDecimal(_ch_0)) {
                        _gotoNext = 4278765i32;
                    } else {
                        _gotoNext = 4278896i32;
                    };
                } else if (__value__ == (4278633i32)) {
                    if (((@:checkr _s ?? throw "null pointer dereference").mode & (4u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4278688i32;
                    } else {
                        _gotoNext = 4278741i32;
                    };
                } else if (__value__ == (4278688i32)) {
                    _tok_1 = (-2 : stdgo.GoInt32);
                    _ch_0 = @:check2r _s._scanIdentifier();
                    _gotoNext = 4279701i32;
                } else if (__value__ == (4278741i32)) {
                    _gotoNext = 4278741i32;
                    _ch_0 = @:check2r _s._next();
                    0i32;
                    _gotoNext = 4279701i32;
                } else if (__value__ == (4278765i32)) {
                    if (((@:checkr _s ?? throw "null pointer dereference").mode & (24u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4278824i32;
                    } else {
                        _gotoNext = 4278872i32;
                    };
                } else if (__value__ == (4278824i32)) {
                    {
                    ...
                    _gotoNext = 4279701i32;
                } else if (__value__ == (4278872i32)) {
                    _gotoNext = 4278872i32;
                    _ch_0 = @:check2r _s._next();
                    0i32;
                    _gotoNext = 4279701i32;
                } else if (__value__ == (4278896i32)) {
                    _gotoNext = 4278907i32;
                } else if (__value__ == (4278907i32)) {
                    {
                        final __value__ = _ch_0;
                        if (__value__ == ((-1 : stdgo.GoInt32))) {
                            _gotoNext = 4278921i32;
                        } else if (__value__ == ((34 : stdgo.GoInt32))) {
                            _gotoNext = 4278942i32;
                        } else if (__value__ == ((39 : stdgo.GoInt32))) {
                            _gotoNext = 4279047i32;
                        } else if (__value__ == ((46 : stdgo.GoInt32))) {
                            _gotoNext = 4279144i32;
                        } else if (__value__ == ((47 : stdgo.GoInt32))) {
                            _gotoNext = 4279263i32;
                        } else if (__value__ == ((96 : stdgo.GoInt32))) {
                            _gotoNext = 4279533i32;
                        } else {
                            _gotoNext = 4279644i32;
                        };
                    };
                } else if (__value__ == (4278921i32)) {
                    _gotoNext = 4279701i32;
                } else if (__value__ == (4278942i32)) {
                    if (((@:checkr _s ?? throw "null pointer dereference").mode & (64u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4278982i32;
                    } else {
                        _gotoNext = 4279031i32;
                    };
                } else if (__value__ == (4278982i32)) {
                    @:check2r _s._scanString((34 : stdgo.GoInt32));
                    _tok_1 = (-6 : stdgo.GoInt32);
                    _gotoNext = 4279031i32;
                } else if (__value__ == (4279031i32)) {
                    _ch_0 = @:check2r _s._next();
                    _gotoNext = 4279701i32;
                } else if (__value__ == (4279047i32)) {
                    if (((@:checkr _s ?? throw "null pointer dereference").mode & (32u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4279086i32;
                    } else {
                        _gotoNext = 4279128i32;
                    };
                } else if (__value__ == (4279086i32)) {
                    @:check2r _s._scanChar();
                    _tok_1 = (-5 : stdgo.GoInt32);
                    _gotoNext = 4279128i32;
                } else if (__value__ == (4279128i32)) {
                    _ch_0 = @:check2r _s._next();
                    _gotoNext = 4279701i32;
                } else if (__value__ == (4279144i32)) {
                    _ch_0 = @:check2r _s._next();
                    if ((stdgo._internal.text.scanner.Scanner__isdecimal._isDecimal(_ch_0) && (((@:checkr _s ?? throw "null pointer dereference").mode & (16u32 : stdgo.GoUInt) : stdgo.GoUInt) != (0u32 : stdgo.GoUInt)) : Bool)) {
                        _gotoNext = 4279217i32;
                    } else {
                        _gotoNext = 4279701i32;
                    };
                } else if (__value__ == (4279217i32)) {
                    {

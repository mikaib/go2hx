...
@:keep @:allow(stdgo._internal.fmt.Fmt.T_pp_asInterface) class T_pp_static_extension {
    ...
    static public function _doPrintf( _p:stdgo.Ref<stdgo._internal.fmt.Fmt_t_pp.T_pp>, _format:stdgo.GoString, _a:stdgo.Slice<stdgo.AnyInterface>):Void {
        @:recv var _p:stdgo.Ref<stdgo._internal.fmt.Fmt_t_pp.T_pp> = _p;
        var _i_4105696:stdgo.GoInt = (0 : stdgo.GoInt);
        var _afterIndex_4105588:Bool = false;
        var _argNum_4105517:stdgo.GoInt = (0 : stdgo.GoInt);
        var _arg_4109623:stdgo.AnyInterface = (null : stdgo.AnyInterface);
        var _lasti_4105739:stdgo.GoInt = (0 : stdgo.GoInt);
        var _formatLoopBreak = false;
        var _end_4105497:stdgo.GoInt = (0 : stdgo.GoInt);
        var _i_4109620:stdgo.GoInt = (0 : stdgo.GoInt);
        var _size_4108613:stdgo.GoInt = (0 : stdgo.GoInt);
        var _verb_4108607:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _c_4106036:stdgo.GoUInt8 = (0 : stdgo.GoUInt8);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _end_4105497 = (_format.length);
                    _argNum_4105517 = (0 : stdgo.GoInt);
                    _afterIndex_4105588 = false;
                    (@:checkr _p ?? throw "null pointer dereference")._reordered = false;
                    _gotoNext = 4105679i32;
                } else if (__value__ == (4105679i32)) {
                    _i_4105696 = (0 : stdgo.GoInt);
                    _formatLoopBreak = false;
                    _gotoNext = 4105692i32;
                } else if (__value__ == (4105692i32)) {
                    if (!_formatLoopBreak && ((_i_4105696 < _end_4105497 : Bool))) {
                        _gotoNext = 4105713i32;
                    } else {
                        _gotoNext = 4109523i32;
                    };
                } else if (__value__ == (4105713i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._goodArgNum = true;
                    _lasti_4105739 = _i_4105696;
                    var __blank__ = 0i32;
                    _gotoNext = 4105752i32;
                } else if (__value__ == (4105752i32)) {
                    if (((_i_4105696 < _end_4105497 : Bool) && (_format[(_i_4105696 : stdgo.GoInt)] != (37 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4105784i32;
                    } else {
                        _gotoNext = 4105799i32;
                    };
                } else if (__value__ == (4105784i32)) {
                    _i_4105696++;
                    _gotoNext = 4105752i32;
                } else if (__value__ == (4105799i32)) {
                    if ((_i_4105696 > _lasti_4105739 : Bool)) {
                        _gotoNext = 4105812i32;
                    } else {
                        _gotoNext = 4105858i32;
                    };
                } else if (__value__ == (4105812i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString((_format.__slice__(_lasti_4105739, _i_4105696) : stdgo.GoString)?.__copy__());
                    _gotoNext = 4105858i32;
                } else if (__value__ == (4105858i32)) {
                    if ((_i_4105696 >= _end_4105497 : Bool)) {
                        _gotoNext = 4105870i32;
                    } else {
                        _gotoNext = 4105946i32;
                    };
                } else if (__value__ == (4105870i32)) {
                    _gotoNext = 4109523i32;
                } else if (__value__ == (4105946i32)) {
                    _i_4105696++;
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._fmt._clearflags();
                    _gotoNext = 4105996i32;
                } else if (__value__ == (4105996i32)) {
                    var __blank__ = 0i32;
                    _simpleFormatBreak = false;
                    _gotoNext = 4106012i32;
                } else if (__value__ == (4106012i32)) {
                    if (!_simpleFormatBreak && ((_i_4105696 < _end_4105497 : Bool))) {
                        _gotoNext = 4106031i32;
                    } else {
                        _gotoNext = 4107066i32;
                    };
                } else if (__value__ == (4106027i32)) {
                    _i_4105696++;
                    _gotoNext = 4106012i32;
                } else if (__value__ == (4106031i32)) {
                    _c_4106036 = _format[(_i_4105696 : stdgo.GoInt)];
                    _gotoNext = 4106054i32;
                } else if (__value__ == (4106054i32)) {
                    {
                        final __value__ = _c_4106036;
                        if (__value__ == ((35 : stdgo.GoUInt8))) {
                            _gotoNext = 4106068i32;
                        } else if (__value__ == ((48 : stdgo.GoUInt8))) {
                            _gotoNext = 4106104i32;
                        } else if (__value__ == ((43 : stdgo.GoUInt8))) {
                            _gotoNext = 4106187i32;
                        } else if (__value__ == ((45 : stdgo.GoUInt8))) {
                            _gotoNext = 4106222i32;
                        } else if (__value__ == ((32 : stdgo.GoUInt8))) {
                            _gotoNext = 4106320i32;
                        } else {
                            _gotoNext = 4106356i32;
                        };
                    };
                } else if (__value__ == (4106068i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._sharp = true;
                    _gotoNext = 4106027i32;
                } else if (__value__ == (4106104i32)) {
                    ...
                    _gotoNext = 4106027i32;
                } else if (__value__ == (4106320i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._space = true;
                    _gotoNext = 4106027i32;
                } else if (__value__ == (4106356i32)) {
                    if (((((97 : stdgo.GoUInt8) <= _c_4106036 : Bool) && (_c_4106036 <= (122 : stdgo.GoUInt8) : Bool) : Bool) && (_argNum_4105517 < (_a.length) : Bool) : Bool)) {
                        _gotoNext = 4106533i32;
                    } else {
                        _gotoNext = 4106991i32;
                    };
                } else if (__value__ == (4106533i32)) {
                    _gotoNext = 4106540i32;
                } else if (__value__ == (4106540i32)) {
                    {
                        final __value__ = _c_4106036;
                        if (__value__ == ((119 : stdgo.GoUInt8))) {
                            _gotoNext = 4106556i32;
                        } else if (__value__ == ((118 : stdgo.GoUInt8))) {
                            _gotoNext = 4106641i32;
                        } else {
                            _gotoNext = 4106826i32;
                        };
                    };
                } else if (__value__ == (4106556i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._wrappedErrs = ((@:checkr _p ?? throw "null pointer dereference")._wrappedErrs.__append__(_argNum_4105517));
                    _gotoNext = 4106641i32;
                } else if (__value__ == (4106641i32)) {
                    ...
                    _gotoNext = 4106826i32;
                } else if (__value__ == (4106826i32)) {
                    @:check2r _p._printArg(_a[(_argNum_4105517 : stdgo.GoInt)], (_c_4106036 : stdgo.GoInt32));
                    _argNum_4105517++;
                    _i_4105696++;
                    _gotoNext = 4105692i32;
                } else if (__value__ == (4106991i32)) {
                    _simpleFormatBreak = true;
                    _gotoNext = 4106012i32;
                } else if (__value__ == (4107066i32)) {
                    {
                        var __tmp__ = @:check2r _p._argNumber(_argNum_4105517, _format?.__copy__(), _i_4105696, (_a.length));
                        _argNum_4105517 = @:tmpset0 __tmp__._0;
                        _i_4105696 = @:tmpset0 __tmp__._1;
                        _afterIndex_4105588 = @:tmpset0 __tmp__._2;
                    };
                    if (((_i_4105696 < _end_4105497 : Bool) && (_format[(_i_4105696 : stdgo.GoInt)] == (42 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4107186i32;
                    } else {
                        _gotoNext = 4107593i32;
                    };
                } else if (__value__ == (4107186i32)) {
                    _i_4105696++;
                    {
                        var __tmp__ = stdgo._internal.fmt.Fmt__intfromarg._intFromArg(_a, _argNum_4105517);
                        ...
                        _argNum_4105517 = @:tmpset0 __tmp__._2;
                    };
                    if (!(@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._widPresent) {
                        _gotoNext = 4107283i32;
                    } else {
                        _gotoNext = 4107426i32;
                    };
                } else if (__value__ == (4107283i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString(("%!(BADWIDTH)" : stdgo.GoString));
                    _gotoNext = 4107426i32;
                } else if (__value__ == (4107426i32)) {
                    if (((@:checkr _p ?? throw "null pointer dereference")._fmt._wid < (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4107443i32;
                    } else {
                        _gotoNext = 4107565i32;
                    };
                } else if (__value__ == (4107443i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._wid = -(@:checkr _p ?? throw "null pointer dereference")._fmt._wid;
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._minus = true;
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._zero = false;
                    _gotoNext = 4107565i32;
                } else if (__value__ == (4107565i32)) {
                    _afterIndex_4105588 = false;
                    _gotoNext = 4107771i32;
                } else if (__value__ == (4107593i32)) {
                    _gotoNext = 4107593i32;
                    {
                        var __tmp__ = stdgo._internal.fmt.Fmt__parsenum._parsenum(_format?.__copy__(), _i_4105696, _end_4105497);
                        (@:checkr _p ?? throw "null pointer dereference")._fmt._wid = @:tmpset0 __tmp__._0;
                        (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._widPresent = @:tmpset0 __tmp__._1;
                        _i_4105696 = @:tmpset0 __tmp__._2;
                    };
                    if ((_afterIndex_4105588 && (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._widPresent : Bool)) {
                        _gotoNext = 4107693i32;
                    } else {
                        _gotoNext = 4107771i32;
                    };
                } else if (__value__ == (4107693i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._goodArgNum = false;
                    _gotoNext = 4107771i32;
                } else if (__value__ == (4107771i32)) {
                    if ((((_i_4105696 + (1 : stdgo.GoInt) : stdgo.GoInt) < _end_4105497 : Bool) && (_format[(_i_4105696 : stdgo.GoInt)] == (46 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4107804i32;
                    } else {
                        _gotoNext = 4108452i32;
                    };
                } else if (__value__ == (4107804i32)) {
                    _i_4105696++;
                    if (_afterIndex_4105588) {
                        _gotoNext = 4107830i32;
                    } else {
                        _gotoNext = 4107878i32;
                    };
                } else if (__value__ == (4107830i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._goodArgNum = false;
                    _gotoNext = 4107878i32;
                } else if (__value__ == (4107878i32)) {
                    {
                        var __tmp__ = @:check2r _p._argNumber(_argNum_4105517, _format?.__copy__(), _i_4105696, (_a.length));
                        _argNum_4105517 = @:tmpset0 __tmp__._0;
                        _i_4105696 = @:tmpset0 __tmp__._1;
                    ...
                    if (((_i_4105696 < _end_4105497 : Bool) && (_format[(_i_4105696 : stdgo.GoInt)] == (42 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4107975i32;
                    } else {
                        _gotoNext = 4108290i32;
                    };
                } else if (__value__ == (4107975i32)) {
                    _i_4105696++;
                    {
                        var __tmp__ = stdgo._internal.fmt.Fmt__intfromarg._intFromArg(_a, _argNum_4105517);
                    ...
                    if (((@:checkr _p ?? throw "null pointer dereference")._fmt._prec < (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4108126i32;
                    } else {
                        _gotoNext = 4108189i32;
                    };
                } else if (__value__ == (4108126i32)) {
                    ...
                    if (!(@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._precPresent) {
                        _gotoNext = 4108382i32;
                    } else {
                        _gotoNext = 4108452i32;
                    };
                } else if (__value__ == (4108382i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._prec = (0 : stdgo.GoInt);
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._precPresent = true;
                    _gotoNext = 4108452i32;
                } else if (__value__ == (4108452i32)) {
                    if (!_afterIndex_4105588) {
                        _gotoNext = 4108467i32;
                    } else {
                        _gotoNext = 4108542i32;
                    };
                } else if (__value__ == (4108467i32)) {
                    {
                        var __tmp__ = @:check2r _p._argNumber(_argNum_4105517, _format?.__copy__(), _i_4105696, (_a.length));
                        _argNum_4105517 = @:tmpset0 __tmp__._0;
                        _i_4105696 = @:tmpset0 __tmp__._1;
                    ...
                    _gotoNext = 4108542i32;
                } else if (__value__ == (4108542i32)) {
                    if ((_i_4105696 >= _end_4105497 : Bool)) {
                        _gotoNext = 4108554i32;
                    } else {
                        _gotoNext = 4108607i32;
                    };
                } else if (__value__ == (4108554i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString(("%!(NOVERB)" : stdgo.GoString));
                    _gotoNext = 4109523i32;
                } else if (__value__ == (4108607i32)) {
                    {
                        final __tmp__0 = (_format[(_i_4105696 : stdgo.GoInt)] : stdgo.GoInt32);
                        final __tmp__1 = (1 : stdgo.GoInt);
                        _verb_4108607 = __tmp__0;
                        _size_4108613 = __tmp__1;
                    };
                    if ((_verb_4108607 >= (128 : stdgo.GoInt32) : Bool)) {
                        _gotoNext = 4108667i32;
                    } else {
                        _gotoNext = 4108727i32;
                    };
                } else if (__value__ == (4108667i32)) {
                    {
                        var __tmp__ = stdgo._internal.unicode.utf8.Utf8_decoderuneinstring.decodeRuneInString((_format.__slice__(_i_4105696) : stdgo.GoString)?.__copy__());
                        _verb_4108607 = @:tmpset0 __tmp__._0;
                        _size_4108613 = @:tmpset0 __tmp__._1;
                    };
                    _gotoNext = 4108727i32;
                } else if (__value__ == (4108727i32)) {
                    _i_4105696 = (_i_4105696 + (_size_4108613) : stdgo.GoInt);
                    _gotoNext = 4108740i32;
                } else if (__value__ == (4108740i32)) {
                    if (_verb_4108607 == ((37 : stdgo.GoInt32))) {
                        _gotoNext = 4108751i32;
                    } else if (!(@:checkr _p ?? throw "null pointer dereference")._goodArgNum) {
                        _gotoNext = 4108861i32;
                    } else if ((_argNum_4105517 >= (_a.length) : Bool)) {
                        _gotoNext = 4108904i32;
                    } else if (_verb_4108607 == ((119 : stdgo.GoInt32))) {
                        _gotoNext = 4109007i32;
                    } else if (_verb_4108607 == ((118 : stdgo.GoInt32))) {
                        _gotoNext = 4109091i32;
                    } else {
                        _gotoNext = 4109271i32;
                    };
                } else if (__value__ == (4108751i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeByte((37 : stdgo.GoUInt8));
                    _gotoNext = 4105692i32;
                } else if (__value__ == (4108861i32)) {
                    @:check2r _p._badArgNum(_verb_4108607);
                    _gotoNext = 4105692i32;
                } else if (__value__ == (4108904i32)) {
                    @:check2r _p._missingArg(_verb_4108607);
                    _gotoNext = 4105692i32;
                } else if (__value__ == (4109007i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._wrappedErrs = ((@:checkr _p ?? throw "null pointer dereference")._wrappedErrs.__append__(_argNum_4105517));
                    _gotoNext = 4109091i32;
                } else if (__value__ == (4109091i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._sharpV = (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._sharp;
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._sharp = false;
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._plusV = (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._plus;
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._plus = false;
                    _gotoNext = 4109271i32;
                } else if (__value__ == (4109271i32)) {
                    @:check2r _p._printArg(_a[(_argNum_4105517 : stdgo.GoInt)], _verb_4108607);
                    _argNum_4105517++;
                    _gotoNext = 4105692i32;
                } else if (__value__ == (4109523i32)) {
                    if ((!(@:checkr _p ?? throw "null pointer dereference")._reordered && (_argNum_4105517 < (_a.length) : Bool) : Bool)) {
                        _gotoNext = 4109558i32;
                    } else {
                        _gotoNext = 4109914i32;
                    };
                } else if (__value__ == (4109558i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._fmt._clearflags();
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString(("%!(EXTRA " : stdgo.GoString));
                    if ((0i32 : stdgo.GoInt) < ((_a.__slice__(_argNum_4105517) : stdgo.Slice<stdgo.AnyInterface>).length)) {
                        _gotoNext = 4109885i32;
                    } else {
                        _gotoNext = 4109890i32;
                    };
                } else if (__value__ == (4109620i32)) {
                    _i_4109620++;
                    _gotoNext = 4109886i32;
                } else if (__value__ == (4109647i32)) {
                    _arg_4109623 = stdgo.Go.toInterface((_a.__slice__(_argNum_4105517) : stdgo.Slice<stdgo.AnyInterface>)[(_i_4109620 : stdgo.GoInt)]);
                    if ((_i_4109620 > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4109661i32;
                    } else {
                        _gotoNext = 4109711i32;
                    };
                } else if (__value__ == (4109661i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString((", " : stdgo.GoString));
                    _gotoNext = 4109711i32;
                } else if (__value__ == (4109711i32)) {
                    if (_arg_4109623 == null) {
                        _gotoNext = 4109725i32;
                    } else {
                        _gotoNext = 4109775i32;
                    };
                } else if (__value__ == (4109725i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString(("<nil>" : stdgo.GoString));
                    _gotoNext = 4109620i32;
                } else if (__value__ == (4109775i32)) {
                    _gotoNext = 4109775i32;
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString((stdgo._internal.reflect.Reflect_typeof.typeOf(_arg_4109623).string() : stdgo.GoString)?.__copy__());
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeByte((61 : stdgo.GoUInt8));
                    @:check2r _p._printArg(_arg_4109623, (118 : stdgo.GoInt32));
                    var __blank__ = 0i32;
                    _gotoNext = 4109620i32;
                } else if (__value__ == (4109885i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = stdgo.Go.toInterface((_a.__slice__(_argNum_4105517) : stdgo.Slice<stdgo.AnyInterface>)[(0i32 : stdgo.GoInt)]);
                        _i_4109620 = __tmp__0;
                        _arg_4109623 = __tmp__1;
                    };
                    _gotoNext = 4109886i32;
                } else if (__value__ == (4109886i32)) {
                    if (_i_4109620 < ((_a.__slice__(_argNum_4105517) : stdgo.Slice<stdgo.AnyInterface>).length)) {
                        _gotoNext = 4109647i32;
                    } else {
                        _gotoNext = 4109890i32;
                    };
                } else if (__value__ == (4109890i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeByte((41 : stdgo.GoUInt8));
                    _gotoNext = 4109914i32;
                } else if (__value__ == (4109914i32)) {
                    _gotoNext = -1i32;
                };
            };
        };

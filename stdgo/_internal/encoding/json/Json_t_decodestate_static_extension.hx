...
@:keep @:allow(stdgo._internal.encoding.json.Json.T_decodeState_asInterface) class T_decodeState_static_extension {
    ...
    static public function _rescanLiteral( _d:stdgo.Ref<stdgo._internal.encoding.json.Json_t_decodestate.T_decodeState>):Void {
        ...
        var _i_5211092:stdgo.GoInt = (0 : stdgo.GoInt);
        var _data_5211086:stdgo.Slice<stdgo.GoUInt8> = (null : stdgo.Slice<stdgo.GoUInt8>);
        var _gotoNext = 0i32;
                ...
                if (__value__ == (0i32)) {
                    {
                        ...
                        _data_5211086 = __tmp__0;
                        _i_5211092 = __tmp__1;
                    };
                    _gotoNext = 5211111i32;
                } else if (__value__ == (5211111i32)) {
                    switchBreak = false;
                    _gotoNext = 5211120i32;
                } else if (__value__ == (5211120i32)) {
                    if (!switchBreak) {
                        {
                            final __value__ = _data_5211086[(_i_5211092 - (1 : stdgo.GoInt) : stdgo.GoInt)];
                            if (__value__ == ((34 : stdgo.GoUInt8))) {
                                _gotoNext = 5211140i32;
                                ...
                                _gotoNext = 5211329i32;
                            } else if (__value__ == ((116 : stdgo.GoUInt8))) {
                                _gotoNext = 5211574i32;
                            } else if (__value__ == ((102 : stdgo.GoUInt8))) {
                                _gotoNext = 5211611i32;
                            } else if (__value__ == ((110 : stdgo.GoUInt8))) {
                                _gotoNext = 5211650i32;
                            } else {
                                _gotoNext = 5211690i32;
                            };
                        };
                    } else {
                        _gotoNext = 5211690i32;
                    };
                } else if (__value__ == (5211140i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 5211162i32;
                } else if (__value__ == (5211162i32)) {
                    if ((_i_5211092 < (_data_5211086.length) : Bool)) {
                        _gotoNext = 5211187i32;
                    } else {
                        _gotoNext = 5211690i32;
                    };
                } else if (__value__ == (5211183i32)) {
                    _i_5211092++;
                    _gotoNext = 5211162i32;
                } else if (__value__ == (5211187i32)) {
                    _gotoNext = 5211192i32;
                } else if (__value__ == (5211192i32)) {
                    {
                        final __value__ = _data_5211086[(_i_5211092 : stdgo.GoInt)];
                        if (__value__ == ((92 : stdgo.GoUInt8))) {
                            _gotoNext = 5211212i32;
                        } else if (__value__ == ((34 : stdgo.GoUInt8))) {
                            _gotoNext = 5211250i32;
                        } else {
                            _gotoNext = 5211183i32;
                        };
                    };
                } else if (__value__ == (5211212i32)) {
                    _i_5211092++;
                    _gotoNext = 5211183i32;
                } else if (__value__ == (5211250i32)) {
                    _i_5211092++;
                    switchBreak = true;
                    _gotoNext = 5211120i32;
                } else if (__value__ == (5211329i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 5211401i32;
                } else if (__value__ == (5211401i32)) {
                    if ((_i_5211092 < (_data_5211086.length) : Bool)) {
                        _gotoNext = 5211426i32;
                    } else {
                        _gotoNext = 5211690i32;
                    };
                } else if (__value__ == (5211422i32)) {
                    _i_5211092++;
                    _gotoNext = 5211401i32;
                } else if (__value__ == (5211426i32)) {
                    _gotoNext = 5211431i32;
                } else if (__value__ == (5211431i32)) {
                    {
                        final __value__ = _data_5211086[(_i_5211092 : stdgo.GoInt)];
                        if (__value__ == ((48 : stdgo.GoUInt8)) || __value__ == ((49 : stdgo.GoUInt8)) || __value__ == ((50 : stdgo.GoUInt8)) || __value__ == ((51 : stdgo.GoUInt8)) || __value__ == ((52 : stdgo.GoUInt8)) || __value__ == ((53 : stdgo.GoUInt8)) || __value__ == ((54 : stdgo.GoUInt8)) || __value__ == ((55 : stdgo.GoUInt8)) || __value__ == ((56 : stdgo.GoUInt8)) || __value__ == ((57 : stdgo.GoUInt8)) || __value__ == ((46 : stdgo.GoUInt8)) || __value__ == ((101 : stdgo.GoUInt8)) || __value__ == ((69 : stdgo.GoUInt8)) || __value__ == ((43 : stdgo.GoUInt8)) || __value__ == ((45 : stdgo.GoUInt8))) {
                            _gotoNext = 5211451i32;
                        } else {
                            _gotoNext = 5211538i32;
                        };
                    };
                } else if (__value__ == (5211451i32)) {
                    _gotoNext = 5211422i32;
                } else if (__value__ == (5211538i32)) {
                    switchBreak = true;
                    _gotoNext = 5211120i32;
                } else if (__value__ == (5211574i32)) {
                    _i_5211092 = (_i_5211092 + (((("rue" : stdgo.GoString) : stdgo.GoString).length)) : stdgo.GoInt);
                    _gotoNext = 5211690i32;
                } else if (__value__ == (5211611i32)) {
                    _i_5211092 = (_i_5211092 + (((("alse" : stdgo.GoString) : stdgo.GoString).length)) : stdgo.GoInt);
                    _gotoNext = 5211690i32;
                } else if (__value__ == (5211650i32)) {
                    _i_5211092 = (_i_5211092 + (((("ull" : stdgo.GoString) : stdgo.GoString).length)) : stdgo.GoInt);
                    _gotoNext = 5211690i32;
                } else if (__value__ == (5211690i32)) {
                    if ((_i_5211092 < (_data_5211086.length) : Bool)) {
                        _gotoNext = 5211707i32;
                    } else {
                        _gotoNext = 5211762i32;
                    };
                } else if (__value__ == (5211707i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._opcode = stdgo._internal.encoding.json.Json__stateendvalue._stateEndValue((stdgo.Go.setRef((@:checkr _d ?? throw "null pointer dereference")._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_t_scanner.T_scanner>), _data_5211086[(_i_5211092 : stdgo.GoInt)]);
                    _gotoNext = 5211789i32;
                } else if (__value__ == (5211762i32)) {
                    _gotoNext = 5211762i32;
                    (@:checkr _d ?? throw "null pointer dereference")._opcode = (10 : stdgo.GoInt);
                    var __blank__ = 0i32;
                    _gotoNext = 5211789i32;
                } else if (__value__ == (5211789i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._off = (_i_5211092 + (1 : stdgo.GoInt) : stdgo.GoInt);
                    _gotoNext = -1i32;
                };
            };
        };

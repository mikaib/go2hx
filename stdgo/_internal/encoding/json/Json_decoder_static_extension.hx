        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 5449161i32;
                } else if (__value__ == (5449161i32)) {
                    0i32;
                    inputBreak = false;
                    _gotoNext = 5449272i32;
                } else if (__value__ == (5449272i32)) {
                    if (!inputBreak && ((_scanp_8 >= (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 5449287i32;
                    } else {
                        _gotoNext = 5450382i32;
                    };
                } else if (__value__ == (5449287i32)) {
                    0i32;
                    _gotoNext = 5449333i32;
                } else if (__value__ == (5449333i32)) {
                    if ((_scanp_8 < ((@:checkr _dec ?? throw "null pointer dereference")._buf.length) : Bool)) {
                        _gotoNext = 5449369i32;
                    } else {
                        _gotoNext = 5450089i32;
                    };
                } else if (__value__ == (5449361i32)) {
                    _scanp_8++;
                    _gotoNext = 5449333i32;
                } else if (__value__ == (5449369i32)) {
                    ...
                    _gotoNext = 5449417i32;
                } else if (__value__ == (5449417i32)) {
                    {
                        ...
                        if (__value__ == ((10 : stdgo.GoInt))) {
                            _gotoNext = 5449457i32;
                        } else if (__value__ == ((5 : stdgo.GoInt)) || __value__ == ((8 : stdgo.GoInt))) {
                            _gotoNext = 5449670i32;
                        } else if (__value__ == ((11 : stdgo.GoInt))) {
                            _gotoNext = 5449924i32;
                        } else {
                            _gotoNext = 5449361i32;
                        };
                    };
                } else if (__value__ == (5449457i32)) {
                    (@:checkr _dec ?? throw "null pointer dereference")._scan._bytes--;
                    inputBreak = true;
                    _gotoNext = 5449272i32;
                } else if (__value__ == (5449670i32)) {
                    if (stdgo._internal.encoding.json.Json__stateendvalue._stateEndValue((stdgo.Go.setRef((@:checkr _dec ?? throw "null pointer dereference")._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_t_scanner.T_scanner>), (32 : stdgo.GoUInt8)) == ((10 : stdgo.GoInt))) {
                        _gotoNext = 5449883i32;
                    } else {
                        _gotoNext = 5449361i32;
                    };
                } else if (__value__ == (5449883i32)) {
                    _scanp_8++;
                    inputBreak = true;
                    _gotoNext = 5449272i32;
                } else if (__value__ == (5449924i32)) {
                    ...
                    _gotoNext = 5449361i32;
                } else if (__value__ == (5450089i32)) {
                    if (_err_9 != null) {
                        _gotoNext = 5450103i32;
                    } else {
                        _gotoNext = 5450310i32;
                    };
                } else if (__value__ == (5450103i32)) {
                    if (stdgo.Go.toInterface(_err_9) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 5450125i32;
                    } else {
                        _gotoNext = 5450272i32;
                    };
                } else if (__value__ == (5450125i32)) {

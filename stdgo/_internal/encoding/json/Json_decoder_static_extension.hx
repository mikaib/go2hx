        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 5472353i32;
                } else if (__value__ == (5472353i32)) {
                    0i32;
                    inputBreak = false;
                    _gotoNext = 5472464i32;
                } else if (__value__ == (5472464i32)) {
                    if (!inputBreak && ((_scanp_8 >= (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 5472479i32;
                    } else {
                        _gotoNext = 5473574i32;
                    };
                } else if (__value__ == (5472479i32)) {
                    0i32;
                    _gotoNext = 5472525i32;
                } else if (__value__ == (5472525i32)) {
                    if ((_scanp_8 < ((@:checkr _dec ?? throw "null pointer dereference")._buf.length) : Bool)) {
                        _gotoNext = 5472561i32;
                    } else {
                        _gotoNext = 5473281i32;
                    };
                } else if (__value__ == (5472553i32)) {
                    _scanp_8++;
                    _gotoNext = 5472525i32;
                } else if (__value__ == (5472561i32)) {
                    ...
                    _gotoNext = 5472609i32;
                } else if (__value__ == (5472609i32)) {
                    {
                        ...
                        if (__value__ == ((10 : stdgo.GoInt))) {
                            _gotoNext = 5472649i32;
                        } else if (__value__ == ((5 : stdgo.GoInt)) || __value__ == ((8 : stdgo.GoInt))) {
                            _gotoNext = 5472862i32;
                        } else if (__value__ == ((11 : stdgo.GoInt))) {
                            _gotoNext = 5473116i32;
                        } else {
                            _gotoNext = 5472553i32;
                        };
                    };
                } else if (__value__ == (5472649i32)) {
                    (@:checkr _dec ?? throw "null pointer dereference")._scan._bytes--;
                    inputBreak = true;
                    _gotoNext = 5472464i32;
                } else if (__value__ == (5472862i32)) {
                    if (stdgo._internal.encoding.json.Json__stateendvalue._stateEndValue((stdgo.Go.setRef((@:checkr _dec ?? throw "null pointer dereference")._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_t_scanner.T_scanner>), (32 : stdgo.GoUInt8)) == ((10 : stdgo.GoInt))) {
                        _gotoNext = 5473075i32;
                    } else {
                        _gotoNext = 5472553i32;
                    };
                } else if (__value__ == (5473075i32)) {
                    _scanp_8++;
                    inputBreak = true;
                    _gotoNext = 5472464i32;
                } else if (__value__ == (5473116i32)) {
                    ...
                    _gotoNext = 5472553i32;
                } else if (__value__ == (5473281i32)) {
                    if (_err_9 != null) {
                        _gotoNext = 5473295i32;
                    } else {
                        _gotoNext = 5473502i32;
                    };
                } else if (__value__ == (5473295i32)) {
                    if (stdgo.Go.toInterface(_err_9) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 5473317i32;
                    } else {
                        _gotoNext = 5473464i32;
                    };
                } else if (__value__ == (5473317i32)) {

...
return { _0 : _c, _1 : (null : stdgo.Error) };
    ...
    static public function _readValue( _dec:stdgo.Ref<stdgo._internal.encoding.json.Json_decoder.Decoder>):{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } {
        @:recv var _dec:stdgo.Ref<stdgo._internal.encoding.json.Json_decoder.Decoder> = _dec;
        var _scanp_5412740:stdgo.GoInt = (0 : stdgo.GoInt);
        var _n_5413923:stdgo.GoInt = (0 : stdgo.GoInt);
        var _c_5412987:stdgo.GoUInt8 = (0 : stdgo.GoUInt8);
        var inputBreak = false;
        var _err_5412764:stdgo.Error = (null : stdgo.Error);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _scanp_5412740 = (@:checkr _dec ?? throw "null pointer dereference")._scanp;
                    _gotoNext = 5412774i32;
                } else if (__value__ == (5412774i32)) {
                    var __blank__ = 0i32;
                    inputBreak = false;
                    _gotoNext = 5412885i32;
                } else if (__value__ == (5412885i32)) {
                    if (!inputBreak && ((_scanp_5412740 >= (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 5412900i32;
                    } else {
                        _gotoNext = 5413995i32;
                    };
                } else if (__value__ == (5412900i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 5412946i32;
                } else if (__value__ == (5412946i32)) {
                    if ((_scanp_5412740 < ((@:checkr _dec ?? throw "null pointer dereference")._buf.length) : Bool)) {
                        _gotoNext = 5412982i32;
                    } else {
                        _gotoNext = 5413702i32;
                    };
                } else if (__value__ == (5412974i32)) {
                    _scanp_5412740++;
                    _gotoNext = 5412946i32;
                } else if (__value__ == (5412982i32)) {
                    _c_5412987 = (@:checkr _dec ?? throw "null pointer dereference")._buf[(_scanp_5412740 : stdgo.GoInt)];
                    (@:checkr _dec ?? throw "null pointer dereference")._scan._bytes++;
                    _gotoNext = 5413030i32;
                } else if (__value__ == (5413030i32)) {
                    {
                        final __value__ = (@:checkr _dec ?? throw "null pointer dereference")._scan._step((stdgo.Go.setRef((@:checkr _dec ?? throw "null pointer dereference")._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_t_scanner.T_scanner>), _c_5412987);
                        if (__value__ == ((10 : stdgo.GoInt))) {
                            _gotoNext = 5413070i32;
                        } else if (__value__ == ((5 : stdgo.GoInt)) || __value__ == ((8 : stdgo.GoInt))) {
                            _gotoNext = 5413283i32;
                        } else if (__value__ == ((11 : stdgo.GoInt))) {
                            _gotoNext = 5413537i32;
                        } else {
                            _gotoNext = 5412974i32;
                        };
                    };
                } else if (__value__ == (5413070i32)) {
                    (@:checkr _dec ?? throw "null pointer dereference")._scan._bytes--;
                    inputBreak = true;
                    _gotoNext = 5412885i32;
                } else if (__value__ == (5413283i32)) {
                    if (stdgo._internal.encoding.json.Json__stateendvalue._stateEndValue((stdgo.Go.setRef((@:checkr _dec ?? throw "null pointer dereference")._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_t_scanner.T_scanner>), (32 : stdgo.GoUInt8)) == ((10 : stdgo.GoInt))) {
                        _gotoNext = 5413496i32;
                    } else {
                        _gotoNext = 5412974i32;
                    };
                } else if (__value__ == (5413496i32)) {
                    _scanp_5412740++;
                    inputBreak = true;
                    _gotoNext = 5412885i32;
                } else if (__value__ == (5413537i32)) {
                    ...
                    _gotoNext = 5412974i32;
                } else if (__value__ == (5413702i32)) {
                    if (_err_5412764 != null) {
                        _gotoNext = 5413716i32;
                    } else {
                        _gotoNext = 5413923i32;
                    };
                } else if (__value__ == (5413716i32)) {
                    if (stdgo.Go.toInterface(_err_5412764) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 5413738i32;
                    } else {
                        _gotoNext = 5413885i32;
                    };
                } else if (__value__ == (5413738i32)) {
                    if ((@:checkr _dec ?? throw "null pointer dereference")._scan._step((stdgo.Go.setRef((@:checkr _dec ?? throw "null pointer dereference")._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_t_scanner.T_scanner>), (32 : stdgo.GoUInt8)) == ((10 : stdgo.GoInt))) {
                        _gotoNext = 5413788i32;
                    } else {
                        _gotoNext = 5413817i32;
                    };
                } else if (__value__ == (5413788i32)) {
                    inputBreak = true;
                    _gotoNext = 5412885i32;
                } else if (__value__ == (5413817i32)) {
                    if (stdgo._internal.encoding.json.Json__nonspace._nonSpace((@:checkr _dec ?? throw "null pointer dereference")._buf)) {
                        _gotoNext = 5413838i32;
                    } else {
                        _gotoNext = 5413885i32;
                    };
                } else if (__value__ == (5413838i32)) {
                    _err_5412764 = stdgo._internal.io.Io_errunexpectedeof.errUnexpectedEOF;
                    _gotoNext = 5413885i32;
                } else if (__value__ == (5413885i32)) {
                    (@:checkr _dec ?? throw "null pointer dereference")._err = _err_5412764;
                    return { _0 : (0 : stdgo.GoInt), _1 : _err_5412764 };
                    _gotoNext = 5413923i32;
                } else if (__value__ == (5413923i32)) {
                    _n_5413923 = (_scanp_5412740 - (@:checkr _dec ?? throw "null pointer dereference")._scanp : stdgo.GoInt);
                    _err_5412764 = @:check2r _dec._refill();
                    _scanp_5412740 = ((@:checkr _dec ?? throw "null pointer dereference")._scanp + _n_5413923 : stdgo.GoInt);
                    _gotoNext = 5412885i32;
                } else if (__value__ == (5413995i32)) {
                    return { _0 : (_scanp_5412740 - (@:checkr _dec ?? throw "null pointer dereference")._scanp : stdgo.GoInt), _1 : (null : stdgo.Error) };
                    _gotoNext = -1i32;
                };
            };
        };

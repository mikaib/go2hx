        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if (((((@:checkr _finfo_3707337 ?? throw "null pointer dereference")._flags & (1 : stdgo._internal.encoding.xml.Xml_t_fieldflags.T_fieldFlags) : stdgo._internal.encoding.xml.Xml_t_fieldflags.T_fieldFlags) == ((0 : stdgo._internal.encoding.xml.Xml_t_fieldflags.T_fieldFlags)) || (((@:checkr _finfo_3707337 ?? throw "null pointer dereference")._parents.length) < (_parents.length) : Bool) : Bool) || ((@:checkr _finfo_3707337 ?? throw "null pointer dereference")._xmlns != ((stdgo.Go.str() : stdgo.GoString)) && (@:checkr _finfo_3707337 ?? throw "null pointer dereference")._xmlns != ((@:checkr _start ?? throw "null pointer dereference").name.space) : Bool) : Bool)) {
                ...
                } else if (__value__ == (3708465i32)) {
                    {
                        ...
                        _tok_3708473 = @:tmpset0 __tmp__._0;
                        _err = @:tmpset0 __tmp__._1;
                    };
                    if (_err != null) {
                ...
                } else if (__value__ == (3708577i32)) {
                    {
                        ...
                        _consumed2_3708751 = @:tmpset0 __tmp__._0;
                        _err_3708762 = @:tmpset0 __tmp__._1;
                    };
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    {
                        var __tmp__ = @:check2r _d.token();
                        _tok_3698290 = @:tmpset0 __tmp__._0;
                        _err_3698295 = @:tmpset0 __tmp__._1;
                    };
                    ...
                    {
                        {
                            ...
                            _t_3698357 = @:tmpset0 __tmp__._0?.__copy__();
                            _ok_3698360 = @:tmpset0 __tmp__._1;
                        };
                        if (_ok_3698360) {
                    ...
                    _v_3699866.set(stdgo._internal.reflect.Reflect_valueof.valueOf(stdgo.Go.toInterface(stdgo.Go.asInterface((@:checkr _start ?? throw "null pointer dereference").name)))?.__copy__());
                    _gotoNext = 3703181i32;
                    ...
                    _sv_3699781 = _v_3699866?.__copy__();
                    {
                        ...
                        _tinfo_3699810 = @:tmpset0 __tmp__._0;
                        _err_3699835 = @:tmpset0 __tmp__._1;
                    };
                    ...
                    if ((((@:checkr _finfo_3701033 ?? throw "null pointer dereference")._name != (stdgo.Go.str() : stdgo.GoString)) && ((@:checkr _finfo_3701033 ?? throw "null pointer dereference")._name != (@:checkr _start ?? throw "null pointer dereference").name.local) : Bool)) {
                    ...
                    if ((((@:checkr _finfo_3701033 ?? throw "null pointer dereference")._xmlns != (stdgo.Go.str() : stdgo.GoString)) && ((@:checkr _finfo_3701033 ?? throw "null pointer dereference")._xmlns != (@:checkr _start ?? throw "null pointer dereference").name.space) : Bool)) {
                    ...
                    {
                        {
                            ...
                            _ok_3701571 = @:tmpset0 __tmp__._1;
                        };
                        if (_ok_3701571) {
                    ...
                    _fv_3701523.set(stdgo._internal.reflect.Reflect_valueof.valueOf(stdgo.Go.toInterface(stdgo.Go.asInterface((@:checkr _start ?? throw "null pointer dereference").name)))?.__copy__());
                    _gotoNext = 3701681i32;
                    ...
                    if (((_a_3701688.name.local == (@:checkr _finfo_3701782 ?? throw "null pointer dereference")._name) && ((((@:checkr _finfo_3701782 ?? throw "null pointer dereference")._xmlns == (stdgo.Go.str() : stdgo.GoString)) || ((@:checkr _finfo_3701782 ?? throw "null pointer dereference")._xmlns == _a_3701688.name.space) : Bool)) : Bool)) {
                    ...
                    {
                        var __tmp__ = @:check2r _d.token();
                        _tok_3703280 = @:tmpset0 __tmp__._0;
                        _err_3703285 = @:tmpset0 __tmp__._1;
                    };
                ...
                } else if (__value__ == (3703426i32)) {
                    {
                        ...
                        _consumed_3703389 = @:tmpset0 __tmp__._0;
                        _err_3703285 = @:tmpset0 __tmp__._1;
                    };
                    if (_err_3703285 != null) {
